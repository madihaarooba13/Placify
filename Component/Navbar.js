...
//                 {/* 🖥️ Centered welcome text on large screen */}
//                 <span className="text-sm sm:text-lg md:text-3xl font-semibold tracking-wide whitespace-nowrap text-center">
//                   Welcome,&nbsp;
//                   <span className="text-white/95">@{username}</span>
//                 </span>
//               </div>
