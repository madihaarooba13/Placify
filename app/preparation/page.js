...
export default function PreparationModulePage() {
  ...
  // 🩵 Show login card immediately if user not logged in
  if (!session) {
    return (
      <div className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-b from-sky-100 via-white to-sky-50">
        <div className="bg-white shadow-2xl border border-gray-200 rounded-3xl p-10 max-w-md text-center flex flex-col items-center">
          ...
          <h2 className="text-2xl font-bold text-sky-700 mb-3">
            Please log in to access preparation module 📚
          </h2>
          <p className="text-gray-600 mb-6 text-sm max-w-xs">
            Sign in to view assignments, upload tasks, and take quizzes.
          </p>
          <button
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-center">
                      <button
                        ...
                        className="bg-sky-600 hover:bg-sky-700 text-white px-4 py-2 rounded-lg text-xs transition hover:cursor-pointer"
                      >
                        Start Quiz ➡️
                      </button>
                    </td>
