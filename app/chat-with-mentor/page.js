...
export default function ChatWithMentor() {
  ...
  if (!session) {
    return (
      <main className="flex flex-col justify-center items-center min-h-[80vh] px-4 text-center">
        <div className="bg-white p-10 rounded-2xl shadow-2xl border border-gray-200 max-w-md mt-30">
          <h2 className="text-2xl font-semibold text-sky-600 mb-3">
            Please login to chat with mentor 💬
          </h2>
          <p className="text-gray-600 mb-6">
            You must be signed in to access the chat feature.
          </p>
          <Link href="/login">
            <button className="bg-gradient-to-r from-sky-600 to-emerald-600 hover:from-sky-700 hover:to-emerald-700 text-white font-semibold px-8 py-3 rounded-xl shadow-md transition-all duration-200 hover:cursor-pointer">
              Login
            </button>
          </Link>
        </div>
  ...
  // 🧱 Logged in → show chat
  return (
    <main className="mt-36 flex justify-center items-center min-h-[80vh] px-4  lg:mt-30">
      {!isMounted ? (
        <div className="text-center mt-32 text-gray-500">Loading chat...</div>
      ) : (
        <div className="bg-white shadow-2xl rounded-2xl w-full max-w-4xl h-[77vh] flex flex-col border border-gray-200 overflow-hidden">
          {/* 🧠 Header */}
          <div className="bg-gradient-to-r from-sky-600 to-emerald-500 p-4 flex justify-between items-center text-white">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 flex items-center justify-center rounded-full bg-white text-sky-700 font-bold">
          ...
          <div className="p-4 flex items-center bg-white border-t border-gray-200">
            ...
            <button
              onClick={sendMessage}
              className="ml-3 bg-gradient-to-r from-sky-600 to-emerald-600 hover:from-sky-700 hover:to-emerald-700 text-white font-semibold px-6 py-2 rounded-xl shadow-md transition-all duration-200 hover:cursor-pointer"
            >
              Send
            </button>
          </div>
