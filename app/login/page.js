...
//     <div className='text-white py-29 container mx-auto'>
//         <h1 className='text-center font-bold text-3xl'>Login to Get Started</h1>

//     <div className="flex flex-col gap-2 my-15 justify-center items-center">


// <button
// onClick={()=>{signIn("google")}}
//     className="flex items-center  bg-white w-80 justify-center border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 hover:cursor-pointer">
