...
export default function CombinedSkillDashboard() {
  ...
  // 🧱 If user not logged in → show message + button
  if (!session)
    return (
      <main className="min-h-screen flex flex-col items-center justify-center bg-sky-50 text-center px-4">
        <div className="bg-white shadow-xl rounded-2xl p-10 max-w-md border border-gray-200">
          <h2 className="text-2xl font-semibold text-sky-700 mb-3">
            Please login to open the dashboard 💼
          </h2>
          <p className="text-gray-600 mb-6">
            Sign in to view your personalized skill growth and mentor feedback.
          </p>
          <Link href="/login">
            <button className="bg-sky-600 text-white px-8 py-3 rounded-xl font-semibold hover:bg-sky-700 transition-transform duration-300 hover:scale-105 hover:cursor-pointer">
              Login
            </button>
          </Link>
        </div>
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-sky-100 via-white to-emerald-50 p-8 md:p-16 mt-38 lg:mt-18">
      <h1 className="text-4xl font-bold text-center text-sky-800 mb-4">
        Placify Skill Growth Dashboard 💼
      </h1>
      <p className="text-gray-700 text-center mb-8 max-w-2xl mx-auto">
      ...
      <div className="bg-white mt-16 p-8 rounded-2xl shadow-lg text-center max-w-3xl mx-auto">
        ...
        <button
          onClick={fetchData}
          className="bg-sky-600 hover:bg-sky-700 text-white px-6 py-2 rounded-xl font-semibold transition-transform hover:scale-105 hover:cursor-pointer"
        >
          Refresh Dashboard 🔄
        </button>
      </div>
