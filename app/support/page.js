  ...
  const faqs = [
    {
      question: "How do I register for placements?",
      answer:
        "Go to the Placement section and fill in your details. Our mentors will guide you further.",
    },
    {
      question: "Can I access AI chatbot for interview prep?",
      answer:
        "Yes! Navigate to the AI Chatbot section to get instant answers and practice questions.",
    },
    {
      question: "How to contact mentors?",
      answer:
        "You can use the contact form below or join our Discord community for real-time support.",
    },
  ];
  ...
  return (
    <main className="min-h-screen bg-sky-50 p-20 mt-4">
      ...
      <section className="text-center py-16">
        ...
        <p className="text-lg md:text-xl text-gray-700">
          Placify support makes your placement journey smooth. Chat, read FAQs,
      ...
      <section className="max-w-2xl mx-auto mb-16">
        ...
        >
          ...
          <button
            type="submit"
            className="bg-sky-600 text-white px-6 py-3 rounded-full font-semibold hover:bg-sky-700 transition-transform duration-300 hover:scale-105 hover:cursor-pointer"
          >
            Send Message
          </button>
        </form>
      ...
      <section className="max-w-4xl mx-auto mb-16">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 text-center">
          <p className="text-gray-700 mb-4">
            Ask your placement questions here!
          </p>
          <Link href="/ai-chatbot">
            <button className="bg-sky-600 text-white px-6 py-3 rounded-full font-semibold hover:bg-sky-700 transition-transform duration-300 hover:scale-105 hover:cursor-pointer">
              Launch Chatbot 🤖
            </button>
          </Link>
        </div>
